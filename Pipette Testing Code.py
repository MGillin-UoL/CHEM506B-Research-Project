...
Description:
This script controls a UR5e robotic arm, a Robotiq Hand-E adaptive gripper to 
simulate a dropwise solvent synthesis. This was designed using the workspace
available in the Central Teaching Laboratories at the University of Liverpool.
